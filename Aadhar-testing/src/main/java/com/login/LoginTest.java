...
public class LoginTest {
	...
	public void performTest() throws InterruptedException {
		...
		driver.findElement(By.cssSelector(".form-group:nth-child(1) > .ng-untouched")).sendKeys("kavya@gmail.com");
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("kavya@123");
